...
<head>
    <title>鹊经堂管理平台</title>
    <link rel="stylesheet" href="/js/admin/bootstrap/css/bootstrap.min.css">
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            <a href="#" target="_blank" class="logo">
                <span class="logo-mini">服务平台</span>
                <span class="logo-lg"><img src="/img/top_logo.png" style="margin-bottom: 5px"/> </span>
            </a>
            <nav class="navbar navbar-static-top">
                <a class="sidebar-toggle">
                    <span class="sr-only">切换</span>
                </a><span class="index_top"><strong>鹊经堂管理平台</strong></span>
        ...
        <div id="content-wrapper" class="content-wrapper">
            <div class="content-tabs">
                ...
                <nav class="page-tabs menuTabs">
                    <div class="page-tabs-content" style="margin-left: 0px;">
                        <a href="javascript:;" class="menuTab active" data-id="book01.html">网站基础设置</a>
                    </div>
                </nav>
            ...
            <div class="content-iframe" style="overflow: hidden;">
                <div class="mainContent" id="content-main" style="margin: 10px; margin-bottom: 0px; padding: 0;">
                    <iframe class="LRADMS_iframe" width="100%" height="100%" src="/group=admin&action=index&method=setting" frameborder="0" data-id="book01.html"></iframe>
                </div>
            </div>
        </div>
    </div>
