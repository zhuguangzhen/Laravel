...
<head>
    ...
    <style>
        .list .list-left,.list-right,.bottom{
            float:left;
        }
        .list-left{
        ...
        .list-right{
            width:auto;border: 1px solid #C7C0C0;margin-left: 20px;margin-top:30px;display: inline-block;height:auto;padding-left: 10px;
        }
        .list-word{
            display: inline-block;;border: 1px solid white;height:180px;width:600px;
        }
        .list-word,.lis-img{
            float:left;margin-top: 20px;
        }
        .list-word2{
            display: inline-block;;border: 1px solid white;width:700px;padding-top: 20px
        }
        .list-wordone{
            font-size:20px;font-weight:400;color:#555555;padding-top: 20px;padding-left: 20px;
        }
        .list-wordone:hover{
            color:#70B4D6;
        }
        .list-desc{
            padding-left: 20px;color: #ccc;line-height: 20px;display: inline-block;margin-top: 20px;
        }
        .list-desc2{
            width:500px;
        }
        ...
        .list-time{
            float:left;margin-left: 20px;margin-top: 20px;margin-bottom: 20px;color:#0abbb9;
        }
        .list-show{
            margin-top: 16px;
        }
                ...
                <ul>
                    @foreach($article as $v)
                        <a href="/group=news&action=index&method=articleDetail?id={{$v->id}}">
                            <li class="list-info">
                                @if(!empty($v->image))
                                    <image src="{{$path}}article/{{$v->image}}" width="250px" height="180px" class="lis-img"></image>
                                    <div class="list-word">
                                        <span class="list-wordone">{{$v->title}}</span><br>
                                        <span class="list-desc list-desc2">{{$v->desc}}</span>
                                        <div>
                                            <ul >
                                                <li class="list-time">{{$v->create_at}}</li>
                                                <li class="list-time">管理员</li>
                                ...
                                @else
                                    <div class="list-word2">
                                        <span class="list-wordone">{{$v->title}}</span><br>
                                        <span class="list-desc">{{$v->desc}}</span>
                                        <div>
                                            <ul >
                                                <li class="list-time">{{$v->create_at}}</li>
                                                <li class="list-time">管理员</li>
