...
<script src="{{ asset('/js/login/jquery-1.9.1.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('/js/login/jquery.easing.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('/js/login/jQuery.time.js') }}" type="text/javascript"></script>
